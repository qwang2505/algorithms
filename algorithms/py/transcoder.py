...
class Transcoder(object):
    ...
    def __init__(self):
        # all features is empty all time?
        self._all_features = {}
        # setup default config.
        self._default_config = settings.default_config
        # init classifiers with settings.
        # init just create classifier and feature extractor, but not much action
        # in init.
    ...
    def transcode(self, url, dom):
        ...
        #initialize, TODO why clear features?
        ...
        if settings.site_configs.has_key(host):
            ...
            # merge site config with default.
    ...
    def _transcode(self, node):
        # really start transcode.
        # Validate node by valid node classifier, a BooleanClassifier.
        ...
        # TODO understand, this is interesting.
        ...
        for child in node.getchildren():
            ...
            if valid:
                # aggregate children features value into parent.
        ...
        if (self._config["operation_switches"]["hide_empty_nodes"] or self._config["operation_switches"]["drop_empty_nodes"]) and Utils.is_empty_node(node, self._config["default_empty_tags"], self._config["invisible_tags"]):
            ...
            # TODO what been done in postprocess?
    ...
    def _filter_tag_properties(self, node):
        # remove unused properties, like cellpadding, cellspacing
    ...
    def _change_tag_properties(self, node):
        # change width here, from exact pixel to auto
